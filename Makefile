...
KERN = kernel/boot.o kernel/gdt_flush.o kernel/isr_exc.o kernel/remap_pic.o kernel/timer_isr.o kernel/keyboard_isr.o kernel/switch_ctx.o kernel/syscall_entry.o kernel/elf.o kernel/ata.o kernel/ahci.o kernel/kernel.o
CXXFLAGS = -std=c++23 -ffreestanding -fno-exceptions -fno-rtti -mno-red-zone -mgeneral-regs-only -O2 -Wall -Wextra -Wpedantic -Wshadow -Wold-style-cast -Wnull-dereference -Wformat=2 -Wno-misleading-indentation -Werror
...
run: iso
	qemu-system-x86_64 -cdrom buffer.iso -machine q35
